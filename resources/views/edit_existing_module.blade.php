...
<div class="card mb-4" style = "width: 60%; margin-left:20.4%; height: 84%;">
   <div class="card-body" style="padding:2rem;">
       
       
     
       <div class="heading_form" style="color:black; margin-bottom: 5%;">
       <h2>Edit Module: {{$edit_module['module_name']}}</h2>
      </div>
       <form action = "{{url('/')}}/add/project_module/{{$project['id']}}" method = "post">
           ...
           <div class="form-group">
              ...
              <div class="form-group row mb-4">
                  ...
                  <div class="col-sm-15">
                    <input type="text" class="form-control" id="inputEmail3" name = 'module_name' value = {{$edit_module['module_name']}}>
                  </div>
              ...
              <div class="form-group row mb-4">
               ...
               <div class="col-sm-15">
                 <input type="text" class="form-control" id="inputEmail3" name = 'module_weightage' value = {{$edit_module['module_weightage']}}>
               </div>
               <span class="text-danger">
