...
@include('layouts.manager_header')
            ...
            {{-- Body Content in the blade --}}
            <div id="layoutSidenav_content" style = "background: url(https://images.unsplash.com/photo-1511467687858-23d96c32e4ae?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80);
            background-size: cover;">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4 mb-4">Welcome, Manager {{ session('Logged_user')->name }}!</h1>
                        ...
                        <div class="row">
                            <div class="col-xl-4 col-md-6">
                                ...
                                <div class="card-footer d-flex align-items-center justify-content-between">
                                    <a class="small text-white stretched-link" href="{{url('/')}}/all_projects">View details</a>
                            ...
                            <div class="col-xl-4 col-md-6">
                                ...
                                <div class="card-footer d-flex align-items-center justify-content-between">
                                    <a class="small text-white stretched-link" href="{{url('/')}}/edit/members">View details</a>
                                    <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                </div>
                            </div>
                        </div>
