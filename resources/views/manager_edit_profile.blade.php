...
<form action = "{{route('manager_edit_profile_submit')}}" method = "post">
@csrf
    ...
    <fieldset class="form-group row">
      ...
      <div class="col-sm-10">
        <div class="form-check">
          <input class="form-check-input" type="radio" id="gridRadios2"  name = 'role_name' {{$user->role_id == 1 ? "checked" : ""}}>
 ...
 <a href="{{url('/')}}/dashboard/project_manager/"><button type="back" class="btn btn-primary">Back</button></a>
</div>
