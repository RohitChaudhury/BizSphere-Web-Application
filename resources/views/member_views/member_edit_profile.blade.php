...
<form action = "{{route('member_edit_profile_submit')}}" method = "post">
@csrf
  ...
  <fieldset class="form-group row">
      ...
      <div class="col-sm-10">
        <div class="form-check">
          <input class="form-check-input" type="radio" id="gridRadios2" value="Project Member"  {{$user->role_id == 3 ? "checked" : ""}}>
   ...
   <button type="reset" class="btn btn-primary"  style="position: relative; top: 161.5%;">Reset</button>
    </span>
   </div>


   <div class="btn" style="position:relative; left:42%; top: 88%;">
    <div class="form-group row pl-4">
      <span class="col-sm-10">
  ...
  <div class="back" style="position:relative; bottom: 9%; left: 85%;">
   <a href="{{url('/')}}/dashboard/team_member"><button type="back" class="btn btn-primary">Back</button></a>
  </div>
 </div>
   </div>
 </div>
