...
<div class="card mb-4" style = "width: 60%; margin-left:20.4%; height: 68%;;">
 <div class="card-body" style="padding:2rem;">
    ...
    <form action = "{{url('/')}}/member/edit/existing/module/{{$edit_module['id']}}/{{$project['id']}}" method = "post">
      @csrf
    <div class="form-group row mb-4">
      <label for="text" class="col col-form-label">Project Name:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>{{$project['project_name']}} </b></label>
       ...
       <a href="{{url('/')}}/member/view/module/{{$project->id}}"><button type="back" class="btn btn-primary" style="position:relative; left: 87.6%; bottom: 220%">Back</button></a>
      </div>
