...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="">{{App\Models\Role::where('id', session('Logged_user')->role_id)->first()->role_name }}</a>
            <!-- Sidebar Toggle-->
            ...
            <ul class="navbar-nav ms-auto me-0 me-md-3 my-2 my-md-0">
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-left">
                        <a class="dropdown-item" href="{{route('member_edit_profile')}}"><i class="fa-sharp fa-solid fa-pencil fa-sm"></i>&nbsp;&nbsp;Edit Profile</a>
            ...
            <div id="layoutSidenav_nav">
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            <div class="mb-4"></div>
                            <a class="nav-link" href="{{url('/')}}/dashboard/team_member">
                                <div class="sb-nav-link-icon"></div>
                                <i class="fa-solid fa-house"></i>&nbsp;Dashboard
                            </a>
                            <a class="nav-link" href="{{route('add_comments')}}">
                                <div class="sb-nav-link-icon"></div>
                                <i class="fa-solid fa-comment"></i>&nbsp;Comments
                            </a>
                            
                            <a class="nav-link collapsed" href="{{route('member_all_projects')}}" data-bs-toggle="collapse" data-bs-target="#collapseLayouts" aria-expanded="false" aria-controls="collapseLayouts">
                                <div class="sb-nav-link-icon"></div>
