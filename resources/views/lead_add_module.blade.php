...
<div class="card mb-4" style = "width: 60%; height: 84% ;margin-left:20.4%;">
    <div class="card-body" style="padding:2rem;">
        ...
        <form action = "{{url('/')}}/lead/add/project_module/{{$project['id']}}" method = "post">
            @csrf
          ...
          <a href="{{url('/')}}/lead/view/module/{{$project['id']}}"><button type="back" class="btn btn-primary" style="position:relative; left: 87.6%; bottom: 241%">Back</button></a>
          </div>
        </div>
        </div>
